...
import com.kzj.mall.databinding.ActivityBaseListBinding
import com.kzj.mall.widget.ExpandLoadMoewView

abstract class BaseListActivity<P : IPresenter,D>:BaseActivity<P,ActivityBaseListBinding>() {
        ...
        if (isLoadMoreEnable()) {
            listAdapter?.setOnLoadMoreListener(object : BaseQuickAdapter.RequestLoadMoreListener {
                override fun onLoadMoreRequested() {
                    this@BaseListActivity.onLoadMore()
                }
            }, mBinding?.rv)
        }
