...
interface ApiService {
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/take_delivery.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/save_goods_atte.htm")
     ...
     * 个人信息
     */
    @POST("/mobile/kzj/api/user_voucher/customerInfo.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/update_customerInfo.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/my_follow_list.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/batch_delete_follow.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/delete_address_by_id.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/interlucation_list.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/interlucation_info.htm")
     ...
     */
    @FormUrlEncoded
    @POST("/mobile/kzj/api/user_voucher/save_interlucation.htm")
     ...
     * 问答分类
     */
    @POST("/mobile/kzj/api/interlucation_.htm")
