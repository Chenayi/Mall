...
class FlashSaleProvider : BaseItemProvider<HomeEntity, BaseViewHolder>() {
    override fun layout(): Int {
        return R.layout.item_home_flash_sale
    }

    override fun viewType(): Int {
        return HomeEntity.FLASH_SALE
    }
    ...
    constructor(val datas: MutableList<HomeEntity.FlashSale>)
        : BaseQuickAdapter<HomeEntity.FlashSale, BaseViewHolder>(R.layout.item_flash_sale, datas) {
